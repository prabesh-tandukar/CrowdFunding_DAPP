  ...
  const steps = [
    {
      ...
      description:
        "Start by connecting your cryptocurrency wallet to DreamFunder. We support various wallet providers to ensure a seamless experience.",
      icon: "🔗",
    },
    {
      title: "Create or Discover Projects",
      description:
        "As a creator, easily set up your crowdfunding campaign. As a backer, explore innovative projects that resonate with your interests.",
      icon: "🚀",
    },
    {
      title: "Fund with Cryptocurrency",
      description:
        "Contribute to projects using cryptocurrency. Our platform ensures secure and transparent transactions through blockchain technology.",
      icon: "💰",
    },
    {
      title: "Track Progress",
      description:
        "Monitor the funding progress of campaigns in real-time. Smart contracts automatically manage fund distribution based on predefined milestones.",
      icon: "📊",
    },
    {
      title: "Engage with the Community",
      description:
        "Interact with project creators, ask questions, and stay updated on project developments through our community features.",
      icon: "💬",
    },
    {
      title: "Successful Funding",
      description:
        "When a project reaches its funding goal, funds are released to the creator. If the goal isn't met, funds are returned to backers.",
      icon: "🎉",
    },
  ];
            ...
            <div className="relative hidden lg:block">
              <div className="sticky top-12">
                <svg
                  ...
                  width="1280.000000pt"
                  height="853.000000pt"
                  viewBox="0 0 1280.000000 853.000000"
                ...
                >
                  ...
                  >
                    <path
                      d="M2455 7359 c-96 -22 -166 -51 -161 -66 14 -35 46 -251 46 -308 0 -93
...
341 229 623 567 701 93 21 271 12 367 -19z"
                    />
                    <path
                      d="M2683 6376 c-167 -41 -312 -178 -363 -344 -27 -87 -27 -217 0 -305
77 -250 355 -407 604 -342 202 53 355 220 386 423 39 251 -128 500 -381 567
-65 18 -175 18 -246 1z"
                    />
                    <path
                      d="M7085 7029 c-129 -31 -175 -49 -175 -67 0 -9 10 -64 21 -122 25 -123
...
575 71z"
                    />
                    <path
                      d="M7384 5970 c-203 -31 -370 -169 -444 -365 -28 -74 -37 -216 -20 -298
...
98 25 170 0 268 -28 109 -63 170 -150 256 -127 128 -298 187 -466 160z"
                    />
                    <path
                      d="M4365 5304 c-78 -19 -188 -54 -199 -65 -5 -4 4 -70 20 -151 35 -179
...
363 46 134 114 243 216 347 147 150 297 233 500 276 99 20 333 12 435 -16z"
                    />
                    <path
                      d="M4675 4004 c-95 -23 -216 -88 -291 -157 -362 -331 -269 -914 178
-1116 127 -58 268 -74 405 -45 330 68 557 360 540 694 -15 298 -229 557 -517
625 -81 18 -235 18 -315 -1z"
                    />
                    <path
                      d="M9285 5050 c-70 -18 -125 -37 -125 -42 0 -2 9 -49 20 -106 23 -116
...
6 280 -8z"
                    />
                    <path
                      d="M9516 4159 c-72 -18 -174 -80 -228 -138 -233 -254 -127 -650 202
-761 54 -19 81 -21 162 -18 85 4 105 9 173 41 374 178 354 708 -33 858 -64 25
-210 35 -276 18z"
                    />
                    <path
                      d="M10747 2905 c-27 -7 -51 -16 -54 -18 -2 -3 3 -51 11 -107 21 -131 13
...
277 -247 468 45 264 293 422 557 357z"
                    />
                    <path
                      d="M10935 2311 c-184 -48 -285 -231 -228 -412 24 -75 117 -169 191 -193
259 -86 496 157 401 411 -26 68 -92 139 -162 171 -53 25 -153 36 -202 23z"
            ...
            <div>
              <ol className="relative text-gray-300 border-s border-gray-700 dark:border-gray-700 dark:text-gray-400">
                {steps.map((step, index) => (
                  <li key={index} className="mb-10 ms-6">
                    <span className="absolute flex items-center justify-center w-8 h-8 rounded-full -start-4 ring-4 ring-gray-900 bg-blue-900 dark:bg-blue-900">
          ...
          <div className="bg-gray-800 rounded-lg p-8 mt-16">
            <h2 className="text-2xl font-semibold mb-4">
              Why Choose DreamFunder?
            </h2>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>Decentralized platform ensuring transparency and security</li>
              <li>Lower fees compared to traditional crowdfunding sites</li>
              <li>Global accessibility for creators and backers</li>
              <li>Smart contract automation for trustless transactions</li>
          ...
          <section className="mt-12 text-center">
            <p className="text-gray-300 mb-6">
              Ready to bring your ideas to life or support innovative projects?
            </p>
